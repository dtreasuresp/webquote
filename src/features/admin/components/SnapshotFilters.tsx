    ...
    <div className="space-y-3 mb-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-white/5 backdrop-blur-md rounded-lg border border-white/10 text-white placeholder-neutral-400 focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/30 transition-all"
        />
      </div>
