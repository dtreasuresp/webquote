  ...
  return (
    ...
    >
      ...
      <div className="bg-gh-bg-secondary border border-gh-border/30 rounded-lg overflow-hidden">
        <div className="px-4 py-2.5 border-b border-gh-border/20 bg-gh-bg-tertiary/30">
          <h5 className="text-xs font-medium text-gh-text flex items-center gap-2">
            <Plus className="w-3.5 h-3.5 text-gh-accent" /> Agregar Nuevo Servicio Opcional
          </h5>
        </div>
        <div className="p-4">
          <div className="grid md:grid-cols-[2fr,0.8fr,0.8fr,0.8fr,0.8fr,auto] gap-3 items-end">
            <div>
              <label htmlFor="servOpcNombre" className="block text-xs font-medium text-gh-text mb-1.5">
                Nombre
              </label>
              <input
                id="servOpcNombre"
            ...
            <div>
              <label htmlFor="servOpcPrecio" className="block text-xs font-medium text-gh-text mb-1.5">
                Precio
              </label>
              <input
                id="servOpcPrecio"
            ...
            <div>
              <label htmlFor="servOpcGratis" className="block text-xs font-medium text-gh-text mb-1.5">
                Gratis
              </label>
              <input
                id="servOpcGratis"
            ...
            <div>
              <label htmlFor="servOpcPago" className="block text-xs font-medium text-gh-text mb-1.5">
                Pago
              </label>
              <input
                id="servOpcPago"
            ...
            <div>
              <label htmlFor="nuevoServicioOpcionalFrecuencia" className="block text-xs font-medium text-gh-text mb-1.5">
                Tipo Pago
              </label>
              <button
      ...
      {!serviciosOpcionalesValidos && serviciosOpcionales.length > 0 && (
        <div className="p-2.5 bg-gh-warning/10 border border-gh-warning/20 rounded-md flex items-start gap-2">
          <span className="text-xs text-gh-warning">⚠️ Revisa meses (Meses Gratis + Meses Pago deben sumar 12) y que todos tengan nombre y precio.</span>
        </div>
      )}

      {!todoEsValido && (
        <div className="pt-4 border-t border-gh-border/30">
          <div className="p-2.5 bg-gh-accent/10 border border-gh-accent/20 rounded-md flex items-start gap-2">
            <span className="text-xs text-gh-accent">ℹ️ Completa: Nombre del paquete, Desarrollo, Precios servicios y Meses válidos</span>
          </div>
        </div>
      )}
    </motion.div>
