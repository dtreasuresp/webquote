  ...
  try {
    ...
    if (method === "POST") {
      ...
      const snapshot = await prisma.packageSnapshot.create({
        data: {
          ...
          hostingPrice: body.hostingPrice || 0,
          mailboxPrice: body.mailboxPrice || 0,
          dominioPrice: body.dominioPrice || 0,
          mesesGratis: body.mesesGratis || 0,
          mesesPago: body.mesesPago || 0,
    ...
    if (method === "PUT") {
      ...
      const snapshot = await prisma.packageSnapshot.update({
        ...
        data: {
          nombre: body.nombre,
          hostingPrice: body.hostingPrice,
          mailboxPrice: body.mailboxPrice,
          dominioPrice: body.dominioPrice,
          mesesGratis: body.mesesGratis,
          mesesPago: body.mesesPago,
