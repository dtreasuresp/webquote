          ...
          <div className="space-y-12">
            ...
            <InfoCard title="📋 Información General del Cliente">
              <table className="w-full text-sm md:text-base">
                <tbody className="space-y-4">
                  <TableRow label="Empresa" value="Urbanisma Constructora SRL" />
            ...
            <InfoCard title="🎯 Propuesta de Valor y Posicionamiento">
              <div className="space-y-4">
                <div>
                  <h4 className="font-bold text-lg text-primary mb-2">Descripción del Negocio</h4>
                ...
                <div>
                  <h4 className="font-bold text-lg text-primary mb-2">Misión</h4>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>Género: Ambos por igual</li>
                    <li>Nivel Socioeconómico: Todos tienen oportunidades</li>
            ...
            <InfoCard title="📄 Estructura y Contenido del Sitio">
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-bold text-lg text-primary mb-3">Información a Mostrar por Producto</h4>
                  <div className="grid md:grid-cols-2 gap-2">
                    {[
                      ...
                      <div key={index} className="flex items-center gap-2 text-gray-700 bg-blue-50 p-2 rounded">
            ...
            <InfoCard title="🔧 Funcionalidades Especiales Requeridas">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-bold text-lg text-primary mb-3">Características del Sitio</h4>
                  <ul className="space-y-2 text-gray-700">
                    {[
            ...
            <InfoCard title="📸 Contenido Disponible">
              <div className="space-y-3">
                {[
                  ...
                  { item: 'Videos Promocionales', status: '✅ Disponible', note: 'Cliente cuenta con material' },
                  { item: 'Textos/Contenidos', status: '❌ Requiere Creación', note: 'A ser desarrollados por el proveedor' },
                  { item: 'Manual de Marca', status: '❌ No Disponible', note: 'Será generado durante desarrollo' },
                ].map((item, index) => (
