...
const PERMISSIONS = [
  ...
  { code: 'backups.view_config', name: 'Ver configuración de backups', category: 'Backups', description: 'Ver la configuración personalizada de backups' },
  { code: 'backups.edit_config', name: 'Editar configuración de backups', category: 'Backups', description: 'Modificar la configuración personalizada de backups' },
...
const ROLE_PERMISSIONS: Record<UserRole, Record<string, boolean>> = {
  SUPER_ADMIN: {
    ...
    'backups.view_config': true,
    'backups.edit_config': true,
  ...
  CLIENT: {
    ...
    'backups.manage_all': false,
    'backups.configure': false,
    'backups.view_config': false,
    'backups.edit_config': false,
